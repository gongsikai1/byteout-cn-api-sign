...
const getHTTPSProxy = async () => {
    ...
    const locations = {
        ...
        chongqing: 'http://v2.api.juliangip.com/company/postpay/getips?auto_white=1&city=重庆&num=1&pt=1&result_type=json&trade_no=6792146775149790&sign=da6f160cb58a3992297567cbcd1c7abc',
    }
    let res = null;
    let proxyAgent = null;
    try {
